          ...
          <div className="grid gap-10 mx-auto sm:grid-cols-2 lg:grid-cols-4 lg:max-w-screen-lg">
            <div>
              ...
              <div className="flex flex-col sm:text-center">
                <p className="text-lg font-bold">Vinay Gupta</p>
          ...
          <div className="grid gap-10 mx-auto lg:max-w-screen-lg sm:grid-cols-2 lg:grid-cols-4">
            <div className="flex flex-col items-center">
              ...
              <div className="flex flex-col items-center">
                ...
                <div className="flex items-center space-x-3 sm:justify-center mt-1">
                  <a
                    href="https://www.instagram.com/vinaygupta017/"
                    target="_blank"
                    rel="noreferrer"
                  ...
                  >
                    <img
                      src="insta.svg"
                      alt="Instagram"
                      className="max-h-5 max-w-5 transition-transform duration-300 ease-in-out hover:scale-150"
                    />
                  </a>
                  <a
                    href="https://github.com/vinaytheprogrammer"
                  ...
                  >
                    <img
                      src="github.svg"
                      alt="Instagram"
                      className="max-h-6 max-w-6 transition-transform duration-300 ease-in-out hover:scale-150"
                    />
                  </a>
                </div>
              </div>
